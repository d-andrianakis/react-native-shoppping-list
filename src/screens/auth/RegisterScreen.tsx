  ...
  const handleRegister = async () => {
    ...
    try {
      const response = await authApi.register({
        ...
        preferredLanguage: i18n.language as 'en' | 'el' | 'de',
      });
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <View style={styles.form}>
            ...
            <TextInput
              style={styles.input}
              placeholder={`${t('auth.displayName')} (${t('items.optional')})`}
              value={displayName}
            ...
            >
              ...
              <Text style={[styles.linkText, styles.linkTextBold]}>{t('auth.login')}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
